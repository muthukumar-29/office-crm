...
val BrandMagenta      = Color(0xFFC0297A)
val BrandPurple       = Color(0xFF6A0572)
val BrandMagentaLight = Color(0xFFF5D0E8)
val BrandPurpleLight  = Color(0xFFEDD6F0)
val BrandAccent       = Color(0xFFE91E8C)

// Neutrals
val White             = Color(0xFFFFFFFF)
val OffWhite          = Color(0xFFF8F4F9)
...
// ── Backward-compat aliases (used by old screens not yet migrated) ──
val PageBg            = OffWhite
val SurfaceDark       = Color(0xFFF3EBF5)   // was dark card, now light card bg
val BrandBlue         = BrandMagenta        // remap blue → magenta
val BrandOrange       = Color(0xFFB45C00)   // keep warm accent
